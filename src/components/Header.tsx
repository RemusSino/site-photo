...
const Header = () => {
  return (
    <header className="absolute w-full z-10 px-6 py-4">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="flex gap-4">
          ...
          <a href="https://pinterest.com" target="_blank" rel="noopener noreferrer" className="text-white hover:text-gray-200">
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        {/* Logo */}
        <Link href="/" className="text-white text-2xl font-serif tracking-wider absolute left-1/2 -translate-x-1/2">
          ADRIANA SINORCHIAN
        </Link>
